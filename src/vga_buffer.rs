...
#[doc(hidden)]
// this needs to be public to be used, but we don't want it to be seen.
// we should use print! instead, which is why we use #[doc(hidden)]
...
#[macro_export]
// we take in an argument $($arg:tt)* and then pass it to _print()
macro_rules! print {
